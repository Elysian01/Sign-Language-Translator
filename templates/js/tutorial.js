...
const letter_file = ['a.gif', 'b.gif', 'c.gif', 'd.gif', 'e.gif', 'f.gif', 'g.gif', 'h.gif', 'i.gif', 'j.gif', 'k.gif', 'l.gif', 'm.gif', 'n.gif', 'o.gif', 'p.gif', 'q.gif', 'r.gif', 's.gif', 't.gif', 'u.gif', 'v.gif', 'w.gif', 'x.gif', 'y.gif', 'z.gif']
...
const start = async () => {
     ...
     for (letter of letters) {
          // console.log(letter)
          document.getElementById(letter).addEventListener('click', (e) => load_letter_image(e.target.value));
     };
     ...
     const load_letter_image = async (val) => {
          // console.log(val)
          let file = val + ".gif"
          const imageLoader = document.getElementById("image-loader")
